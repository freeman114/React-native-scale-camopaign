...
const getTabTitle = (routeName: string): string => {
  ...
  } else if (routeName === NavigationNames.AppsTab) {
    return getString("Apps");
  } else if (routeName === NavigationNames.ProfileTab) {
    return getString("Profile");
  } else if (routeName === NavigationNames.AccountTab) {
  ...
  tabBarIcon: ({ focused, color, size }) => {
    ...
    switch (route.name) {
      ...
      case NavigationNames.MediaTab:
        ...
        break;
      case NavigationNames.AppsTab:
        iconName = "ios-apps";
        break;
      case NavigationNames.ProfileTab:
        iconName = "md-person";
        break;
      case NavigationNames.AccountTab:
        iconName = "md-person";
        break;
